...
$(document).ready(function() {
	...
	$('a.button_bars_show').click(function() {
		var id;
		id = $(this).attr('bar-id');
	...
	$('a.button_breweries_show').click(function() {
		var id;
